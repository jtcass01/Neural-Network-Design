...
if __name__ == "__main__":
    ...
    print("Note: I am skipping the calculation of the input due the complexity of programatically implementing it.")
    ...
    print("iii. 0.9963", "Transfer functions: (a.) purelin, (b.) satlin, (c.) satlins, (d.) logsig, (e.) tansig, (f.) poslin")
    print("iv. -1.0", "Transfer functions: (a.) hardlims, (b.) purelin, (c.) satlins")